...
def generate_graph_with_grant(grant_name):
    try:
        ...
        return data, grant_data, grant_name, grant_months_remaining, grant_grantee, grant_obligation, grant_liquidated, grant_udo, grant_UDO_percentage
